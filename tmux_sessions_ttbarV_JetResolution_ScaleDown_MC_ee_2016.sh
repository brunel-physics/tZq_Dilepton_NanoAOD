...
for i in ${!ProcessNamesArray[@]}; do
	...
	tmux new -d -s $tmux_string_nominal_ee_2016 'source /cvmfs/sft.cern.ch/lcg/views/LCG_96/x86_64-slc6-gcc8-opt/setup.sh; make clean; make; ./bin/fulleventselectionMain.exe --mc 1 -y 2016 -p '$j' --npl 0 --sr 1 --sbr 0 --zjcr 0 --ttcr 0 --sys 8 --channel 1 --dcc 0; sleep 86400'
...
echo "The tmux sessions for ttbarV in the SR (ee channel for 2016, jet resolution scale down) are running."
