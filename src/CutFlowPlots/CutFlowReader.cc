...
// string process = "SingleTop_tchannel_top";
 ...
 float Two = CutFlowReader2(1, process).at(1);
 float Three = CutFlowReader2(2, process).at(1);
 float Four = CutFlowReader2(3, process).at(1);
 float Five = CutFlowReader2(4, process).at(1);
 float Six = CutFlowReader2(5, process).at(1);
 float Seven = CutFlowReader2(6, process).at(1);
 float Eight = CutFlowReader2(7, process).at(1);
 float Nine = CutFlowReader2(8, process).at(1);
 float Ten = CutFlowReader2(9, process).at(1);
