...
*/
 ...
 auto d_LeptonSelection = d_GoldenJson.Define("PU", PU_function, {"PV_npvs"})
  ...
  std::cout << "before d_MET_And_LeptonSelection" << std::endl;
  ...
  std::cout << "after d_MET_LeptonTriggers_LeptonSelection" << std::endl;
  ...
  std::cout << "before turn on curves" << std::endl;
  ...
  std::cout << "before turn on curves errors" << std::endl;
  ...
  if((ProcessInt == 119 || ProcessInt == 120) && SystematicInt == 0){
   ...
   double TrigSF = Eff_DATA/(Eff_MC + 1.0e-06);
