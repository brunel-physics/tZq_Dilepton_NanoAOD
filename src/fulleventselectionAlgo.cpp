...
void tZq_NanoAOD_Output(const int& MCInt,  	    const int& ProcessInt,  const int& NPLInt,     const int& SRInt,          const int& SBRInt, 
 ...
 auto d_LeptonSelection = d_GoldenJson.Define("PU", PU_function, {"PV_npvs"})
				      ...
				      .Define("LooseLeptonsEta", select<floats>, {"LeptonEta", "LooseLeptons"})
                                      ...
                                      .Define("SubleadingLeptonPt", SubleadingVariable, {"TightLeptonPt"})
                                      .Define("LeadingLeptonPhi", LeadingVariable, {"TightLeptonPhi"})
                                      .Define("SubleadingLeptonPhi", SubleadingVariable, {"TightLeptonPhi"})
                                      .Define("LeadingLeptonEta", LeadingVariable, {"TightLeptonEta"})
                                      .Define("SubleadingLeptonEta", SubleadingVariable, {"TightLeptonEta"})
                                      .Define("LeadingLeptonMass", LeadingVariable, {"TightLeptonMass"})
                                      .Define("SubleadingLeptonMass", SubleadingVariable, {"TightLeptonMass"})
  ...
  if(ProcessInt == 93 || ProcessInt == 94){return;}



  //Z boson candidate reconstruction
  auto d_ZCandidateReco = d_LeptonSelection.Define("OppositeSignNonPrompt", OppositeSignNonPrompt, {"TightLeptonsCharge", "TightLeptonsGenPartFlav"})
