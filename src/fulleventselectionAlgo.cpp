  ...
  switch(ProcessInt){
	...
	case 83: Process = "VV_WW1nuqq_ext";
        ...
        case 85: Process = "VV_WZTo3lNu";
		 ...
		 switch(YearInt){
                        case 2016: break;
                        case 2017: input_files = {"/data/disk0/nanoAOD_2017/WZTo3LNu/*"}; HessianOrMC = "Hessian"; break;
	...
	case 106: Process = "ttbarV_ttZToQQ";
        ...
        case 108: Process = "ttbarV_ttgamma";
		 ...
		 switch(YearInt){
                        ...
                        case 2018: input_files = {"/data/disk1/nanoAOD_2018/ttgamma/*"}; HessianOrMC = "Hessian"; break;
                        default: std::cout << "Please choose a year out of 2016, 2017 or 2018" << std::endl; break;
                 }
        ...
        case 109: Process = "ttbarV_ttgamma_ext";
		 ...
		 switch(YearInt){
                        case 2016: break;
                        case 2017: break;
                        case 2018: input_files = {"/data/disk1/nanoAOD_2018/ttgamma_ext/*"}; HessianOrMC = "Hessian"; break;
                        default: std::cout << "Please choose a year out of 2016, 2017 or 2018" << std::endl; break;
                 }
...
//		else{
		...
		std::cout << "before eta for loop" << std::endl;
		...
		std::cout << "before pt for loop" << std::endl;
		...
		std::cout << "before csvv2 for loop" << std::endl;
		...
		std::cout << "before operating point for loop" << std::endl;
...
*/
			...
			else{std::cout << "inside the FinalOutVec ones else" << std::endl; FinalOutVec.push_back(Ones.at(0));}
