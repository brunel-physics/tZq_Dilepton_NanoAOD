...
for i in ${!ProcessNamesArray2[@]}; do
        ...
        tmux_string2="${ProcessNamesArray2[i]}${SystematicNamesArray[16]}${ChannelArray[0]}_${YearArray[0]}"

        j=$(($i + 45))

        echo './bin/fulleventselectionMain.exe --mc 1 -y 2016 -p '$j' --npl 0 --sr 1 --sbr 0 --zjcr 0 --ttcr 0 --sys 16 --channel 1 --dcc 0'

        tmux new -d -s $tmux_string2 'source /cvmfs/sft.cern.ch/lcg/views/LCG_96/x86_64-slc6-gcc8-opt/setup.sh; make clean; make; ./bin/fulleventselectionMain.exe --mc 1 -y 2016 -p '$j' --npl 0 --sr 1 --sbr 0 --zjcr 0 --ttcr 0 --sys 16 --channel 1 --dcc 0; sleep 86400'
...
for i in ${!ProcessNamesArray3[@]}; do
        ...
        tmux_string3="${ProcessNamesArray3[i]}${SystematicNamesArray[16]}${ChannelArray[0]}_${YearArray[0]}"

        j=$(($i + 64))

        echo './bin/fulleventselectionMain.exe --mc 1 -y 2016 -p '$j' --npl 0 --sr 1 --sbr 0 --zjcr 0 --ttcr 0 --sys 16 --channel 1 --dcc 0'

        tmux new -d -s $tmux_string3 'source /cvmfs/sft.cern.ch/lcg/views/LCG_96/x86_64-slc6-gcc8-opt/setup.sh; make clean; make; ./bin/fulleventselectionMain.exe --mc 1 -y 2016 -p '$j' --npl 0 --sr 1 --sbr 0 --zjcr 0 --ttcr 0 --sys 16 --channel 1 --dcc 0; sleep 86400'
...
echo "The tmux sessions for ttbar in the SR (ee channel for 2016, MET scale down) are running."
