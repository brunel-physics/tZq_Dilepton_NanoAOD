...
//Script adapted from: https://github.com/brunel-physics/tZq_analysis/blob/run_2/scripts/createPileUpMC2017.C

//Bin values from: https://github.com/cms-sw/cmssw/blob/master/SimGeneral/MixingModule/python/mix_2018_25ns_JuneProjectionFull18_PoissonOOTPU_cfi.py

void createPileUpMC2018()
{
    constexpr int nbins{100};
    constexpr std::array<double, nbins> y{
    ...
    TFile* outFile{new TFile{"pileupMC2018.root", "recreate"}};
    TH1D* pileup{new TH1D{"pileup", "pileup", nbins, 0., nbins}};
